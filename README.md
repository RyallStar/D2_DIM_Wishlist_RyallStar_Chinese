...
* DIM中文愿望清单共收录传奇武器904把（普通武器版本830把，增强武器版本74把），异域武器125把，异域职业物品3件。
* DIM中文愿望清单共入选传奇武器不同框架的各属性330把（普通武器版本和增强武器版本计为1把），异域武器85把，异域职业物品60件。
...
* 提光栏位15把（3个游戏角色*头部1件、3个游戏角色臂部1件、3个游戏角色胸部1件、3个游戏角色腿部1件、3个游戏角色职业物品1件）
